...
# ============================
    ...
    with tab_icms:
        ...
        c3.metric(
            ...
            f"{delta_pct:.2f}%".replace(".", ",")
        )

        st.divider()

        # ============================
        # GRÁFICO 1 – EVOLUÇÃO + TENDÊNCIA
        # ============================
        fig1 = go.Figure()
        ...
        top_1 = rank_ano.iloc[[0]]
        last_1 = rank_ano.iloc[[-1]]

        ini = max(pos_mun - janela - 1, 0)
        fim = min(pos_mun + janela, total_mun)
