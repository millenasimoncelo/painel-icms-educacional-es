...
# ============================
    ...
    with tab_icms:
        ...
        # --------------------------------------------------
        # GRÁFICO – Ranking estadual com topo, base e janela local
        # --------------------------------------------------
        if np.isfinite(pos_2026):
            ...
            fig2.add_annotation(
                x=top_1.iloc[0][col_icms],
                y=top_1.iloc[0]["Município"],
            ...
            fig2.add_annotation(
                x=last_1.iloc[0][col_icms],
                y=last_1.iloc[0]["Município"],
